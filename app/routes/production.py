...
def _check_production_shortage(db: Session, production, items_to_use: list) -> list:
    ...
    Hozirgi Stock.quantity ishlatiladi — yakunlash hozirgi vaqtda sodir bo'lganda
    real qoldiq bilan tekshiriladi (vaqt-aware faqat eski sanaga yozish kerak bo'lganda).
    """
    shortage_lines = []
