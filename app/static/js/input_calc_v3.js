/* TOTLI BI — 1C uslubidagi kalkulyator (v3 — nested modal fix)
...
(function () {
  ...
  console.log('[InputCalc v3] loaded');
  ...
  function ensureModal() {
    ...
    if (!modalEl || !displayEl) {
      console.error('[InputCalc v3] Modal element topilmadi — base.html restart kerak');
      return false;
    }
    bindModalEvents();
    return true;
  ...
  function showCalc() {
    ...
    console.log('[InputCalc v3] open — parent modals:', visibleModals.length, 'z-index:', calcZ);
